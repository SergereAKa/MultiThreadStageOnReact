...
@Setter
@Log4j2
public class ReactorProcessFinish extends ReactorProcessBase {
...
//    private  String message;
    ...
    public ReactorProcessFinish(String command, Date reportDate, Date contractDate, String contractType, String comment, int sleeplen) {
