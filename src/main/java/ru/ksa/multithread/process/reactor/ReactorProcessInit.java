...
@Setter
@Log4j2
public class ReactorProcessInit extends ReactorProcessBase {

//    private  String status;
//    private  Exception exception;
//    private  String message;

    public ReactorProcessInit(String command, Date reportDate, Date contractDate, String contractType, String comment, int sleeplen) {
